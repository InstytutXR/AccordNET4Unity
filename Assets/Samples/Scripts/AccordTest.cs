...
public class AccordTest : MonoBehaviour
{
    ...
    public int numberOfFramesPassed = 0; // The number of frames that passed since the game started
    public Vector3 destination; // The current destination point for the moving sphere.
